...
{
	public static inline function getService() : NsIScriptableUnescapeHTML return xpcom.Components.classes[cast "@mozilla.org/feed-unescapehtml;1"].getService(xpcom.Components.interfaces.nsIScriptableUnescapeHTML);
