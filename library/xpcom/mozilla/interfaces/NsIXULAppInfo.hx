...
{
	public static inline function createInstance() : NsIXULAppInfo
	{
		return xpcom.Components.classes[cast "@mozilla.org/xre/app-info;1"].createInstance(NsIXULAppInfo);
	}
