...
@:native("Components.interfaces.nsIPrefBranch") extern class NsIPrefBranch extends NsISupports
{
	...
	function getChildList(aStartingAt:String, ?aCount:ULong, aChildArray:Array<String>) : Void;
	function getComplexValue(aPrefName:String, aType:NsIIDRef, aValue:NsQIResult) : Void;
