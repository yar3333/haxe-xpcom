...
{
	public static inline function getService() : NsIConsoleService return xpcom.Components.classes[cast "@mozilla.org/consoleservice;1"].getService(xpcom.Components.interfaces.nsIConsoleService);
