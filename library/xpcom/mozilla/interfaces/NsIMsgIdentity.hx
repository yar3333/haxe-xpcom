...
@:native("Components.interfaces.nsIMsgIdentity") extern class NsIMsgIdentity extends NsISupports
{
	var identityName : AString;
	/**
	 * User's full name, i.e. John Doe
	 */
	var fullName : AString;
	/**
	 ...
	 */
	var signature : NsILocalFile;
	var signatureDate : Long;
	var escapedVCard : AString;
	var doFcc : Bool;
	var fccFolder : AString;
	var fccFolderPickerMode : AString;
	var fccReplyFollowsParent : Bool;
	var draftsFolderPickerMode : AString;
	var tmplFolderPickerMode : AString;
	/**
	...
	var bccList : AString;
	var doBcc : Bool;
	var doBccList : AString;
	var draftFolder : AString;
	var stationeryFolder : AString;
	var showSaveMsgDlg : Bool;
	var directoryServer : AString;
	var overrideGlobalPref : Bool;
	/**
	 * If this is false, don't append the user's domain to an autocomplete address with no matches.
	 */
	var autocompleteToMyDomain : Bool;
	/**
	 ...
	 */
	var requestReturnReceipt : Bool;
	/**
	 * Readonly:
	 */
	var receiptHeaderType : Long;
	/**
