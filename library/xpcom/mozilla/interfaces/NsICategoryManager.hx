...
{
	public static inline function getService() : NsICategoryManager
	{
		return xpcom.Components.classes[cast "@mozilla.org/categorymanager;1"].getService(NsICategoryManager);
	}
