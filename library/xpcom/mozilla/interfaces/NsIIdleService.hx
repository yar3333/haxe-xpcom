...
{
	public static inline function createInstance() : NsIIdleService
	{
		return xpcom.Components.classes[cast "@mozilla.org/widget/idleservice;1"].createInstance(NsIIdleService);
	}
