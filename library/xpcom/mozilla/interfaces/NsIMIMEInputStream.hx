...
{
	public static inline function createInstance() : NsIMIMEInputStream
	{
		return xpcom.Components.classes[cast "@mozilla.org/network/mime-input-stream;1"].createInstance(NsIMIMEInputStream);
	}
