...
@:native("Components.interfaces.nsIAnnotationService") extern class NsIAnnotationService extends NsISupports
{
	...
	function getPageAnnotationBinary(aURI:NsIURI, aName:AUTF8String, aData:Array<Octet>, aDataLen:{value:ULong}, aMimeType:{value:AUTF8String}) : Void;
	function getItemAnnotationBinary(aItemId:LongLong, aName:AUTF8String, aData:Array<Octet>, aDataLen:{value:ULong}, aMimeType:{value:AUTF8String}) : Void;
	function getPageAnnotationInfo(aURI:NsIURI, aName:AUTF8String, aFlags:{value:PRInt32}, aExpiration:{value:UShort}, aMimeType:{value:AUTF8String}, aType:{value:UShort}) : Void;
	function getItemAnnotationInfo(aItemId:LongLong, aName:AUTF8String, aFlags:{value:Long}, aExpiration:{value:UShort}, aMimeType:{value:AUTF8String}, aType:{value:UShort}) : Void;
	...
	function getPagesWithAnnotation(name:AUTF8String, ?resultCount:{value:ULong}, results:Array<NsIURI>) : Void;
	function getItemsWithAnnotation(name:AUTF8String, ?resultCount:{value:ULong}, results:Array<LongLong>) : Void;
	function getPageAnnotationNames(aURI:NsIURI, ?count:{value:ULong}, result:Array<NsIVariant>) : Void;
	function getItemAnnotationNames(aItemId:LongLong, ?count:{value:ULong}, result:Array<NsIVariant>) : Void;
