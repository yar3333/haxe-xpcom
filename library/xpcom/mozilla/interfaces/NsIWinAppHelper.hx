...
{
	public static inline function createInstance() : NsIWinAppHelper
	{
		return xpcom.Components.classes[cast "@mozilla.org/xre/app-info;1"].createInstance(NsIWinAppHelper);
	}
