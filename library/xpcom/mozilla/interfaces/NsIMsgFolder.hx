...
@:native("Components.interfaces.nsIMsgFolder") extern class NsIMsgFolder extends NsISupports
{
	...
	function getFoldersWithFlag(flags:ULong, resultsize:ULong, numFolders:{value:ULong}) : NsIMsgFolder;
	...
	function getDBFolderInfoAndDB(folderInfo:{value:NsIDBFolderInfo}) : NsIMsgDatabase;
	...
	function getOfflineFileStream(msgKey:NsMsgKey, offset:{value:PRUint32}, size:{value:PRUint32}) : NsIInputStream;
	...
	function getSortKey(key:{value:OctetPtr}, length:{value:ULong}) : Void;
