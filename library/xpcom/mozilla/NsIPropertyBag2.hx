...
@:native("nsIPropertyBag2") extern class NsIPropertyBag2 extends NsIPropertyBag
{
	...
	function getPropertyAsInterface(prop:AString, iid:NsIIDRef, result:NsQIResult) : Void;
