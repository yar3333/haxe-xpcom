function xpcom_mozilla_HttpServerComponent(dump)
{
...
var DEBUG = dump != null; // non-const *only* so tweakable in server tests
 ...
 */
var HTTP_400 = this.HTTP_400 = new HttpError(400, "Bad Request");
var HTTP_401 = this.HTTP_401 = new HttpError(401, "Unauthorized");
var HTTP_402 = this.HTTP_402 = new HttpError(402, "Payment Required");
var HTTP_403 = this.HTTP_403 = new HttpError(403, "Forbidden");
var HTTP_404 = this.HTTP_404 = new HttpError(404, "Not Found");
var HTTP_405 = this.HTTP_405 = new HttpError(405, "Method Not Allowed");
var HTTP_406 = this.HTTP_406 = new HttpError(406, "Not Acceptable");
var HTTP_407 = this.HTTP_407 = new HttpError(407, "Proxy Authentication Required");
var HTTP_408 = this.HTTP_408 = new HttpError(408, "Request Timeout");
var HTTP_409 = this.HTTP_409 = new HttpError(409, "Conflict");
var HTTP_410 = this.HTTP_410 = new HttpError(410, "Gone");
var HTTP_411 = this.HTTP_411 = new HttpError(411, "Length Required");
var HTTP_412 = this.HTTP_412 = new HttpError(412, "Precondition Failed");
var HTTP_413 = this.HTTP_413 = new HttpError(413, "Request Entity Too Large");
var HTTP_414 = this.HTTP_414 = new HttpError(414, "Request-URI Too Long");
var HTTP_415 = this.HTTP_415 = new HttpError(415, "Unsupported Media Type");
var HTTP_417 = this.HTTP_417 = new HttpError(417, "Expectation Failed");

var HTTP_500 = this.HTTP_500 = new HttpError(500, "Internal Server Error");
var HTTP_501 = this.HTTP_501 = new HttpError(501, "Not Implemented");
var HTTP_502 = this.HTTP_502 = new HttpError(502, "Bad Gateway");
var HTTP_503 = this.HTTP_503 = new HttpError(503, "Service Unavailable");
var HTTP_504 = this.HTTP_504 = new HttpError(504, "Gateway Timeout");
var HTTP_505 = this.HTTP_505 = new HttpError(505, "HTTP Version Not Supported");
  ...
  _processBody: function()
  {
    ...
    try
    {
      if (this._contentLength > 0)
      {
        ...
        //dumpn("*** loading data=" + data + " len=" + data.length + " excess=" + (data.length - count));
