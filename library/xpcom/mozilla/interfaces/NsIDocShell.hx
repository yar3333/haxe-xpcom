...
@:native("Components.interfaces.nsIDocShell") extern class NsIDocShell extends NsISupports
{
	...
	function createLoadInfo(loadInfo:{value:NsIDocShellLoadInfo}) : Void;
	...
	function internalLoad(aURI:NsIURI, aReferrer:NsIURI, aOwner:NsISupports, aFlags:PRUint32, aWindowTarget:Wstring, aTypeHint:String, aPostDataStream:NsIInputStream, aHeadersStream:NsIInputStream, aLoadFlags:ULong, aSHEntry:NsISHEntry, firstParty:Bool, aDocShell:{value:NsIDocShell}, aRequest:{value:NsIRequest}) : Void;
	...
	function tabToTreeOwner(forward:Bool, tookFocus:{value:Bool}) : Void;
}
