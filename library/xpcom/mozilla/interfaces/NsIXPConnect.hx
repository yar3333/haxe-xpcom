...
@:native("Components.interfaces.nsIXPConnect") extern class NsIXPConnect extends NsISupports
{
	...
	function getCaller(aJSContext:JSContextPtr, aObject:JSObjectPtr) : Void;
	function getCOWForObject(aJSContext:JSContextPtr, aParent:JSObjectPtr, aWrappedObj:JSObjectPtr) : JSVal;
	function getDefaultSecurityManager(aManager:NsIXPCSecurityManager, flags:PRUint16) : Void;
	...
	function getSecurityManagerForJSContext(aJSContext:JSContextPtr, aManager:NsIXPCSecurityManager, flags:PRUint16) : Void;
	...
	function GetXPCWrappedNativeJSClassInfo(equality:JSEqualityOp) : Void;
	...
	function wrapJS(aJSContext:JSContextPtr, aJSObj:JSObjectPtr, aIID:NsIIDRef, result:NsQIResult) : Void;
	function wrapJSAggregatedToNative(aOuter:NsISupports, aJSContext:JSContextPtr, aJSObj:JSObjectPtr, aIID:NsIIDRef, result:NsQIResult) : Void;
	...
	function wrapNativeToJSVal(aJSContext:JSContextPtr, aScope:JSObjectPtr, aCOMObj:NsISupports, aCache:NsWrapperCachePtr, aIID:NsIIDPtr, aAllowWrapper:Bool, aVal:JSVal, aHolder:NsIXPConnectJSObjectHolder) : Void;
}
