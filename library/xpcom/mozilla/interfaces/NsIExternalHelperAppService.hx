...
{
	public static inline function getService() : NsIExternalHelperAppService return xpcom.Components.classes[cast "@mozilla.org/uriloader/external-helper-app-service;1"].getService(xpcom.Components.interfaces.nsIExternalHelperAppService);
