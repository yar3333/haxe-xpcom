...
@:native("imgIEncoder") extern class ImgIEncoder extends NsIAsyncInputStream
{
	...
	function encodeClipboardImage(aClipboardImage:NsIClipboardImage, aImageFile:NsIFile) : Void;
