...
{
	public static inline function getService() : NsIIOService return xpcom.Components.classes[cast "@mozilla.org/network/io-service;1"].getService(xpcom.Components.interfaces.nsIIOService);
