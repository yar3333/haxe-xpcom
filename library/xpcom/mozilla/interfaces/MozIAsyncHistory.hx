...
{
	public static inline function getService() : MozIAsyncHistory return xpcom.Components.classes[cast "@mozilla.org/browser/history;1"].getService(xpcom.Components.interfaces.mozIAsyncHistory);
