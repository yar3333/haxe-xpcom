...
{
	public static inline function getService() : NsIAlertsService return xpcom.Components.classes[cast "@mozilla.org/alerts-service;1"].getService(xpcom.Components.interfaces.nsIAlertsService);
