...
@:native("Components.interfaces.nsIHTMLEditor") extern class NsIHTMLEditor extends NsISupports
{
	...
	function getAlignment(aMixed:{value:Bool}, aAlign:{value:Short}) : Void;
	function getBackgroundColorState(aMixed:{value:Bool}) : AString;
	function getElementOrParentByTagName(aTagName:AString, aNode:NsIDOMNode) : NsIDOMElement;
	function getFontColorState(aMixed:{value:Bool}) : AString;
	function getFontFaceState(aMixed:{value:Bool}) : AString;
	function getHeadContentsAsHTML() : AString;
	function getHighlightColorState(aMixed:{value:Bool}) : AString;
	function getIndentState(aCanIndent:{value:Bool}, aCanOutdent:{value:Bool}) : Void;
	function getInlineProperty(aProperty:NsIAtom, aAttribute:AString, aValue:AString, aFirst:{value:Bool}, aAny:{value:Bool}, aAll:{value:Bool}) : Void;
	function getInlinePropertyWithAttrValue(aProperty:NsIAtom, aAttribute:AString, aValue:AString, aFirst:{value:Bool}, aAny:{value:Bool}, aAll:{value:Bool}) : AString;
	function getLinkedObjects() : NsISupportsArray;
	function getListItemState(aMixed:{value:Bool}, aLI:{value:Bool}, aDT:{value:Bool}, aDD:{value:Bool}) : Void;
	function getListState(aMixed:{value:Bool}, aOL:{value:Bool}, aUL:{value:Bool}, aDL:{value:Bool}) : Void;
	function getParagraphState(aMixed:{value:Bool}) : AString;
