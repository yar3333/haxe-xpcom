...
{
	public static inline function createInstance() : NsIIdleService return xpcom.Components.Constructor("@mozilla.org/widget/idleservice;1", xpcom.Components.interfaces.nsIIdleService);
