...
@:native("Components.interfaces.mozIStorageVacuumParticipant") extern class MozIStorageVacuumParticipant extends NsISupports
{
	/**
	...
	function onBeginVacuum() : Bool;
	function onEndVacuum(aSucceeded:Bool) : Void;
}
