...
{
	public static inline function getService() : NsIWebContentHandlerRegistrar
	{
		return xpcom.Components.classes[cast "@mozilla.org/embeddor.implemented/web-content-handler-registrar;1"].getService(NsIWebContentHandlerRegistrar);
	}
