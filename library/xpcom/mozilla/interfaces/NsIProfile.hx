...
{
	public static inline function getService() : NsIProfile return xpcom.Components.classes[cast "@mozilla.org/profile/manager;1"].getService(xpcom.Components.interfaces.nsIProfile);
