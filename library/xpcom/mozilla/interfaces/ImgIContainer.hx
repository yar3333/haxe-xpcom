...
@:native("Components.interfaces.imgIContainer") extern class ImgIContainer extends NsISupports
{
	...
	function appendFrame(aX:PRInt32, aY:PRInt32, aWidth:PRInt32, aHeight:PRInt32, aFormat:GfxImageFormat, imageData:Array<PRUint8>, imageLength:{value:ULong}) : Void;
	function appendPalettedFrame(aX:PRInt32, aY:PRInt32, aWidth:PRInt32, aHeight:PRInt32, aFormat:GfxImageFormat, aPaletteDepth:PRUint8, imageData:Array<PRUint8>, imageLength:{value:ULong}, paletteData:Array<PRUint32>, paletteLength:{value:ULong}) : Void;
	function clear() : Void;
	...
	function ensureCleanFrame(aFramenum:ULong, aX:PRInt32, aY:PRInt32, aWidth:PRInt32, aHeight:PRInt32, aFormat:GfxImageFormat, imageData:Array<PRUint8>, imageLength:{value:ULong}) : Void;
	...
	function getFrameColormap(framenumber:ULong, paletteData:Array<PRUint32>, paletteLength:{value:ULong}) : Void;
