...
{
	public static inline function getService() : NsIEffectiveTLDService
	{
		return xpcom.Components.classes[cast "@mozilla.org/network/effective-tld-service;1"].getService(NsIEffectiveTLDService);
	}
